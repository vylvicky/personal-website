  ...
  return (
    <section id="home" className="min-h-[100svh] relative flex flex-col md:flex-row items-stretch" style={{ minHeight: '-webkit-fill-available' }}>
      ...
      <div className="block md:hidden w-full relative overflow-hidden" style={{ height: '50svh' }}>
        <img src={aldrichPhoto} alt="Aldrich" className="absolute inset-0 w-full h-full object-cover" <img src={aldrichPhoto} alt="Aldrich" className="absolute inset-0 w-full h-full object-cover" style={{ objectPosition: 'center 25%' }} /> />
      </div>
